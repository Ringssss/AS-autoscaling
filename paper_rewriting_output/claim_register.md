...
| Ownership protocol prevents double advancement | E10 | Strong within model | The evaluated fault campaign admits one executor and deduplicates managed effects | Arbitrary third-party effects are exactly-once |
